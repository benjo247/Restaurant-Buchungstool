# Restaurant App Starter (Big Sur)
...
- empfohlen für deinen lokalen Schritt mit **Node 18**
...
- Falls der erste Build scheitert: zuerst die Datenbank verbinden
...
Danach sollte die App bei Vercel sauber bauen.
